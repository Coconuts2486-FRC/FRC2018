...
public enum Nodes
{
	...
	BLUE_SCALE_LEFT_SCALE    (0, 0, 0, new Point(8.9246, 5.4929)),

	BLUE_WALL_LEFT_SWITCH    (0, 0, 0, new Point(12.6005, 4.8416)),
	BLUE_SWITCH_LEFT_SWITCH  (0, 0, 0, new Point(11.5297, 4.8416)),
		
	BLUE_WALL_RIGHT_SWITCH   (0, 0, 0, new Point(12.6005, 3.2983)),
	BLUE_SWITCH_RIGHT_SWITCH (0, 0, 0, new Point(11.5297, 3.2983)),
		
	BLUE_WALL_RIGHT_SCALE    (0, 0, 0, new Point(12.6005, 2.4539)),
	BLUE_SWITCH_RIGHT_SCALE  (0, 0, 0, new Point(10.6101, 2.4539)),
	BLUE_AISLE_RIGHT_SCALE   (0, 0, 0, new Point(9.6145, 2.4539)),
	BLUE_SCALE_RIGHT_SCALE   (0, 0, 0, new Point(8.9246, 2.6471)),
    ;
